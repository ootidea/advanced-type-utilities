...
it('converts types of optional properties to T | undefined', () => {
  ...
  assertTypeEquality<MakeOptionalPropertiesAcceptUndefined<{ [Symbol.iterator]?: never }>, { [Symbol.iterator]?: undefined }>()
})
...
it('distributes over union types', () => {
  assertTypeEquality<MakeOptionalPropertiesAcceptUndefined<{ a?: 1 } | { b?: 2 }>, { a?: 1 | undefined } | { b?: 2 | undefined }>()
})
